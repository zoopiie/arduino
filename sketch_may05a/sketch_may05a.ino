// attempt to send to the jpeg decover for displaying on screen. Therefore
// you should only have jpegs in the root dir. Also they must be DOS filenames
// so no filenames over 8 chars. Below follows Bodmers original header
